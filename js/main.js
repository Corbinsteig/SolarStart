...
function calculateSolar () {
    ...
    var feedback="";
        feedback += "<p>Based on you average daily use of "+Math.round(dailyUseKw) +" kWh, you will need to purchase  "+ panelsNeeded +" "+ panelName +" solar panels to offset 100% of your electricity bill.</p>"
